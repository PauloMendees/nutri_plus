  ...
  theme: {
    extend: {
      colors: {
        ...
        // note: gluestack's own numeric `background-*` scale (background-0..950,
        // background-error/warning/muted/success/info) is intentionally dropped
        // here — it collided with our flat `background` token above. Nothing in
        // this app consumes those gluestack background-* utility classes yet.
        indicator: {
