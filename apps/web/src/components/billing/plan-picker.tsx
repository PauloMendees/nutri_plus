    ...
    <div className="space-y-4">
      <div className="flex justify-center gap-2 text-sm">
        <button
          ...
          className={period === 'MONTHLY' ? 'font-semibold underline' : ''}
        >
          Mensal
        </button>
        <button
          ...
          className={period === 'YEARLY' ? 'font-semibold underline' : ''}
        >
          Anual <span className="text-primary">(2 meses grátis)</span>
        </button>
      </div>
          ...
          return (
            <div key={tier} className="rounded-lg border p-6 space-y-3">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li>
                  {cfg.employeeSeats > 0 ? `Até ${cfg.employeeSeats} funcionários` : 'Sem funcionários'}
                </li>
              </ul>
              <Button
                type="button"
